...
public class LongInsulatedWireBridgeHighWattageConfig : IBuildingConfig
{
    public const string ID = "LongInsulatedWireBridgeHighWattage";
    ...
    {
        return "LongInsulatedWireBridgeHighWattage";
    }
    ...
    public override BuildingDef CreateBuildingDef()
    {
        ...
        BuildingDef buildingDef         = BuildingTemplates.CreateBuildingDef(id, 2, 1, "LongInsulatedheavywatttile_kanim", 100, 3f, construction_mass, construction_materials, 1600f, BuildLocationRule.HighWattBridgeTile, tieR5, noise, 0.2f);
        ...
        GeneratedBuildings.RegisterWithOverlay(OverlayScreen.WireIDs, "LongInsulatedWireBridgeHighWattage");
        return buildingDef;
    }
